...
> To add a custom Readme to your GitHub profile, you need to create a new repository that has the same name as your GitHub username. This repository is special – GitHub recognizes it and uses its README.md file to display on your profile page
...
- **GitHub Pro**
> GitHub Pro, the next tier above GitHub Free, also includes Dependabot alerts. This feature is part of GitHub’s broader offering for enhanced repository management and security features
- **GitHub Free**
...
- **Faster performance**
> Local operations in DVCS (like commit, diff, merge) are faster because they don’t need to communicate with a central server
- **Enhanced security**
...
> You can customize the color theme of the Codespace’s editor in the Visual Studio Code settings, which is part of the GitHub Codespace
...
> GitHub supports the use of the "/branch" slash command directly in the comments of an issue. This command creates a new branch named after the issue and links it directly to the issue. This is a part of GitHub’s effort to integrate more automation and ease-of-use features into their platform, facilitating smoother workflows directly from issues
</details>
